...
INPUT_EXTENSIONS = [".jpg", ".jpeg", ".png", ".bmp", ".tiff", ".webp", ".gif", ".ppm", ".tga"]
...
def main():
    ...
    with open(log_file, "w", encoding="utf-8") as log:
        log.write("=== Batch Image Converter — Made by Drew ===\n")
    ...
    if not image_files:
        msg = "No image files found in input folder."
        print(msg)
        write_log(log_file, msg)
        return

    write_log(log_file, "Detected image files:")
    ...
    codec = CODECS[output_ext]
    write_log(log_file, f"Chosen output format: .{output_ext} (codec={codec})")
    ...
    print()
    final_msg_console = "Thank you for using the image converter! Made by Drew"
